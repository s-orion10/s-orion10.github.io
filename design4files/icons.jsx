...
const Icon = ({ name, size = 16, className = "" }) => {
  ...
  switch (name) {
    ...
    case "puzzle":   return <svg {...props}><path d="M15.6 3.5a2 2 0 0 0-3.6 1.2c0 .3.1.6.2.8.2.4 0 .9-.4 1.1a1 1 0 0 1-.9 0l-1.4-.6a1.5 1.5 0 0 0-2 .8L6.7 8.5a1 1 0 0 1-1.2.6 2 2 0 1 0 0 3.8 1 1 0 0 1 1.2.6l.8 1.7a1.5 1.5 0 0 0 2 .8l1.4-.6a1 1 0 0 1 .9 0c.4.2.6.7.4 1.1-.1.2-.2.5-.2.8a2 2 0 1 0 3.6-1.2"/><path d="M15.6 3.5l1.7.8a1.5 1.5 0 0 1 .8 2l-.6 1.4a1 1 0 0 0 0 .9c.2.4.7.6 1.1.4.2-.1.5-.2.8-.2a2 2 0 1 1-1.2 3.6"/></svg>;
